...
//
// JavaScript / CoffeeScript: Extend the String prototype with a method capitalize() so you can call it
// on a string like so: "string".capitalize(). Learn about inheritance and the prototype chain.
//
