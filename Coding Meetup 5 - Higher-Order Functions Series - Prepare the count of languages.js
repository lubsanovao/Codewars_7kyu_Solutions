...
//
// Your task is to return an object (associative array in PHP, table in COBOL) which includes the count of each
...
function countLanguages(list) {
    ...
    for (let i = 0; i < list.length; i++) {
        arrL.push(list[i].language)
    }
    return arrL.reduce((r, c) => (r[c] = (r[c] || 0) + 1, r), {});
}