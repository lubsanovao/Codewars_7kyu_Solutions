...
// the author of this Kata even if it is well-written (i.e. contains suitable Kata Description edits, plenty of
// fixed and random tests, etc.).
//
// Background
// Oh no, there were some problems with your computer and now you cannot convert any data type to strings!
//
// Task
// The toString() method has been disabled for booleans, numbers, arrays and objects. Your goal is to retrive toString()
...
//
// As you may have noticed in the examples above, when the array has more than one element, some of the strings have
// spaces as well as commas separating each item but some strings do not. For the purposes of this Kata whether there
// are whitespaces or not does not matter for stringified arrays - before conducting the tests your input is stripped
// of all whitespace.
//
